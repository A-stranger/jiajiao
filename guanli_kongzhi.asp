...
background=images/top_2_1.gif></TD>
    <TD vAlign=top bgColor=#ffffff><TABLE width="948" border=0 align=center cellPadding=0 cellSpacing=0 bgColor=#ffffff>
      ...
      border=0 align="center" cellPadding=0 cellSpacing=1 bgColor=#cccccc>
          ...
          background=images/my_1_2.gif class=white_link_9><strong><strong><img src="images/my_1_4.gif" width="142" height="58" align="middle"><strong><span class="t">&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;简历控制</span></strong></strong></strong></TD>
                            <TD width="4%" 
...
border=0>
                          <TBODY>
                            <TR>
                              <TD width="742" align=left vAlign=top><% set rs=server.CreateObject("adodb.recordset")
rs.Open "select * from jiaoyuan where id="&id,conn,1,1 %>
                                  <form name="form1" method="post" action="guanli_kongzhi.asp">
                                    <p align="center">
                                      <input name="fg" type="radio" value="是" <% If rs("kongkai")="是" Then %>checked 
					  <% End If %>>
                                      公开
                                      <label>&nbsp;&nbsp;</label>
                                      <input type="radio" name="fg" value="否" <% If rs("kongkai")="否" Then %> checked<% End If %>>
                                      隐藏
                                      <label> <em>&nbsp; </em>
                                        <input name="f" type="submit" id="f" value="提交">
                                      </label>
                                      <input name="g" type="hidden" id="g" value="g">
                                    </p>
                                  </form>
                                <p>&nbsp;</p></TD>
                            </TR>
