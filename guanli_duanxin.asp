...
background=images/top_2_1.gif></TD>
    <TD vAlign=top bgColor=#ffffff><TABLE width="948" border=0 align=center cellPadding=0 cellSpacing=0 bgColor=#ffffff>
      ...
      border=0 align="center" cellPadding=0 cellSpacing=1 bgColor=#cccccc>
          ...
          background=images/my_1_2.gif class=white_link_9><strong><strong><img src="images/my_1_4.gif" width="142" height="58" align="middle"><strong><span class="t">&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;短 信 控 制</span></strong></strong></strong></TD>
                            <TD width="4%" 
...
rs.Open "select * from jiaoyuan where id="&id,conn,1,1 %>
                        ...
                        <form name="form1" method="post" action="guanli_duanxin.asp">
                          <p align="center">
                            <input name="fg" type="radio" value="是" <% If rs("duanxin")="是" Then %>checked 
					  <% End If %>>
                            接收
                            <label>&nbsp;&nbsp;</label>
                            <input type="radio" name="fg" value="否" <% If rs("duanxin")="否" Then %> checked<% End If %>>
                            不接收
                            <label> <em>&nbsp; </em>
