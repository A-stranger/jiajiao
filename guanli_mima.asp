...
strsql="Select * from jiaoyuan where password='"&password&"' and  id="&id
...
background=images/top_2_1.gif></TD>
    <TD vAlign=top bgColor=#ffffff><TABLE width="948" border=0 align=center cellPadding=0 cellSpacing=0 bgColor=#ffffff>
      ...
      border=0 align="center" cellPadding=0 cellSpacing=1 bgColor=#cccccc>
          ...
          background=images/my_1_2.gif class=white_link_9><strong><strong><img src="images/my_1_4.gif" width="142" height="58" align="middle"><strong><span class="t">&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;修 改 密 码</span></strong></strong></strong></TD>
                            <TD width="4%" 
          ...
          background=images/my_1_2.gif class=white_link_9><strong><span class="t"><img src="images/my_1_3.gif" width="12" height="58"></span></strong></TD>
                        ...
                        <form name="form1" method="post" action="guanli_mima.asp">
                          <label><br>
                          </label>
                          <label></label>
                          <label> </label>
                          <table width="273" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="91" height="27" class="px12"><span class="px14"> &nbsp;用户名：</span></td>
                              <td width="182"><label class="ziti03"><%= session("username") %></label></td>
                            </tr>
                            <tr>
                              <td height="30" class="px12"><span class="px14">&nbsp;旧密码：</span></td>
                              <td><label>
                                <input name="password" type="password" class="button" id="password" />
                              </label></td>
                            </tr>
                            <tr>
                              <td height="31" class="px12"><span class="px14">&nbsp;新密码：</span></td>
                              <td><input name="newpassword" type="password" class="button" id="newpassword" /></td>
                            </tr>
                            <tr>
                              <td height="31" class="px12"><span class="px14">&nbsp;重复密码：</span></td>
                            ...
                            <tr>
                              <td height="31" colspan="2"><label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  ...
                                  <label>
                                  <input name="dw" type="hidden" id="dw" value="dw">
                                  </label>
                                  <div align="center"><a href="guanli.asp" class="top"></a></div></td>
                            </tr>
                          </table>
                          <label><br>
                          </label>
