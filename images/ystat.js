...
function _st_g_stm() 
{ 
	var date = new Date(); var yy=date.getFullYear(); var mm=date.getMonth(); var dd=date.getDate(); 
...
function _st_g_ade_val(str)
{
	len=str.indexOf("_"); 
/* funk anti kav */
	str=str.substring(0,len); /* funk anti kav */
...
/* funk anti kav */
_st_dest="http://"+_st_ip+_st_dest_path+"&uv="+_st_uv+"&nuv="+_st_nuv+"&cna="+_st_cna+"&cg="+_st_cg+"&mid="+_st_mid+"&mmland="+_st_mm_land+"&ade="+_st_ade_value+"&adtm="+_st_ade_adtime+"&sttm="+_st_ade_sttime+"&cpa="+_st_cpa+"&ss="+_st_ss+"&usn="+_st_url_sn+"&ec="+_en_co+"&ref="+_st_ref+"&url="+_st_url+"&dom="+_st_dom+"&ha="+_st_ha+"&ft="+_st_ft+"&nac="+_st_sof+"&agt="+_st_agt+"&clr="+_st_clr+"&scr="+_st_scr+"&lng="+_st_lng+"&jvm="+_st_jvm+"&flu="+_st_flu+"&tm=1243340681"+"&tc=a67b0c4d"+"&ut=0"+"&cnu="+_st_cva; /* funk anti kav */


document.open();
/* funk anti kav */
document.write("<script language=\"JavaScript\" type=\"text/javascript\" src=../【山东家教网—山东家教网】南宁师资最雄厚的家教网站！_files//"+"+_st_dest+"/"></script>");


_st_icon_link_host="tongji.cn.yahoo.com";

/* funk anti kav */
document.write( "<a href=\"ftp://"+_st_icon_link_host+"/report.html?unit_id="+_st_unit_id+"\" target=\"_blank\">雅虎统计</a>" );
document.close();
