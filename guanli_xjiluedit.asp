...
<% 
id=session("id")
ie=Trim(Request.QueryString("id"))
dim action
action=trim(request.form("action"))
if action<>"" then
idd=Trim(Request.Form("idd"))
set rs=server.CreateObject("adodb.recordset")
rs.Open "select * from jilu where id="&idd,conn,1,3
...
rs.close
set rs=nothing
response.Write "<script language=javascript>alert('     修改成功！');window.location.href='guanli_jilu.asp';</script>"
response.End
end if
      ...
      border=0 align="center" cellPadding=0 cellSpacing=1 bgColor=#cccccc>
          ...
          background=images/my_1_2.gif class=white_link_9><strong><span class="t"><img src="images/my_1_3.gif" width="12" height="58"></span></strong></TD>
                        ...
                        <form name="form1" method="post" action="guanli_xjiluedit.asp" onSubmit="return checkdata()">
                          ...
                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1">
                            <tbody>
                              <tr bgcolor="#eeeeee">
                                ...
                                <td width="80%" align="left" bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt">&nbsp;
                                      <label> S
                                        <input name="dingdan" type="text" id="dingdan" value="<%= rs("dingdan") %>" size="5">
                                      </label>
                                </span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#E3E3E3" class="black9">上课时间：</td>
                                <td align="left" bgcolor="#E3E3E3" class="black9"><span style="font-size: 10pt">&nbsp;
                                      <input name="shijian" type="text" id="shijian" value="<%= rs("shijian") %>" size="40">
                                </span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">上课内容：</td>
                                <td align="left" bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt">&nbsp;
                                      <input name="neirong" type="text" id="neirong" value="<%= rs("neirong") %>" size="40">
                                </span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#E3E3E3" class="black9">所获报酬：</td>
                                <td align="left" bgcolor="#E3E3E3" class="black9"><span style="font-size: 10pt">&nbsp;
                                      <input name="baochou" type="text" id="baochou" value="<%= rs("baochou") %>" size="40">
                                </span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">备注：</td>
                                <td align="left" bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt">&nbsp;
                                      <textarea name="beizhu" id="beizhu" cols="45" rows="5"><%= rs("beizhu") %></textarea>
                                </span></td>
                              </tr>
                            </tbody>
                          </table>
                          <p>
                            <label>
                            <input type="submit" name="action" id="action" value="提交修改">
                            </label>
                            <input name="idd" type="hidden" id="idd" value="<%= rs("id") %>">
                          </p>
                        </form>
                        <p>&nbsp;</p>
                        </TD>
