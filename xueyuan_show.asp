            ...
            cellSpacing=0 cellPadding=0 width=712>
              <TBODY>
                <TR>
                  ...
                  <TD width=654 align="center" class="heiti px18 spacing1"><span class="STYLE10 spacing1">查看学员订单 <SPAN 
                  class=orange>S<%= rs("id") %></SPAN> 详细情况</span></TD>
                </TR>
              </TBODY>
            </TABLE></TD>
            <TD width=12></TD>
...
<TABLE height=95 cellSpacing=0 cellPadding=0 width=980 align=center border=0>
          ...
          <TR>
            <TD style="COLOR: #333333" vAlign=top width=712>　
              <TABLE cellSpacing=1 cellPadding=0 width=712 border=0>
                ...
                height=34><DIV class="white px13" align=center><STRONG>学 员 个 人 信 
                      息</STRONG></DIV></TD>
                  </TR>
                  <TR>
                    <TD bgColor=#f9f9ec height=30><DIV align=right>订单编号：</DIV></TD>
                    <TD align="left" bgColor=#f9f9ec><DIV align=left>　S<%= rs("id") %></DIV></TD>
                    <TD bgColor=#f9f9ec><DIV align=right>联系人：</DIV></TD>
                    <TD align="left" bgColor=#f9f9ec>　<%= rs("username") %></TD>
                  </TR>
                  <TR>
                    <TD bgColor=#f7f5dc height=30><DIV align=right>学员性别： </DIV></TD>
                    <TD align="left" bgColor=#f7f5dc><DIV align=left>　<%= rs("sex") %></DIV></TD>
                    <TD bgColor=#f7f5dc><DIV align=right>学员年级：</DIV></TD>
                  ...
                  <TR>
                    ...
                    <TD bgColor=#f9f9ec><DIV align=right>大致位置：</DIV></TD>
  ...
  <TR>
    <TD background=images/t_info_10.gif colSpan=2 
                height=34><DIV class="white px13" align=center><STRONG>家 教 辅 导 信 
      息</STRONG></DIV></TD>
  </TR>
  <TR>
    <TD width=134 bgColor=#f9f9ec height=30><DIV align=right>求教科目：</DIV></TD>
    <TD width=575 align="left" bgColor=#f9f9ec>　<%= rs("xueke") %></TD>
  </TR>
  <TR>
    <TD bgColor=#f7f5dc height=30><DIV align=right>
      <DIV align=right>频次：</DIV>
    </DIV></TD>
    <TD align="left" bgColor=#f7f5dc>　<%= rs("anpai") %></TD>
  </TR>
  <TR>
    <TD bgColor=#f9f9ec height=30><DIV align=right>学员情况描述：</DIV></TD>
    <TD align="left" bgColor=#f9f9ec>　<%= rs("qingkuang") %></TD>
  </TR>
  
  <TR>
    <TD bgColor=#F7F5DC height=30><DIV align=right>对教员性别要求：</DIV></TD>
    <TD align="left" bgColor=#F7F5DC>　<%= rs("jsex") %></TD>
  </TR>
  <TR>
    <TD bgColor=#F9F9EC height=30><DIV align=right>对教员要求(接单情况)：</DIV></TD>
    <TD align="left" 
                bgColor=#F9F9EC style="PADDING-LEFT: 12px; LINE-HEIGHT: 20px"><%= rs("jqingkuang") %></TD>
  </TR>
  <TR>
    <TD bgColor=#F7F5DC height=30><DIV align=right>报酬：</DIV></TD>
    <TD align="left" bgColor=#F7F5DC>　<%= rs("baochou") %>元/小时</TD>
  </TR>
  <TR>
    <TD bgColor=#F7F5DC height=30><div align="right">报酬：</div></TD>
    <TD align="left" bgColor=#F7F5DC> &nbsp; <%= rs("baochou2") %>元/月</TD>
  </TR>
  <TR>
    <TD bgColor=#F9F9EC height=30><DIV align=right>教学方式：</DIV></TD>
    <TD align="left" bgColor=#F9F9EC>　<%= rs("fangshi") %></TD>
  </TR>
  <TR bgColor=#f9f9ec>
    <TD height=30 bgcolor="#F7F5DC"><DIV align=right>有无车贴：</DIV></TD>
    <TD align="left" bgcolor="#F7F5DC">　<%= rs("chetie") %>车贴</TD>
  </TR>
  </TBODY>
              </TABLE>
              <TABLE cellSpacing=0 cellPadding=0 width=712 border=0>
				...
				<% if rs("zhaungtai")="已结单" then %>
                 <% response.write("<font color='#ff0000'><b>此订单已安排,请关注其他订单</b></font>")%>
                  <% Else %> 
				 <A href="shenqing.asp?dw=<%= id %>" target="_blank"><%response.write("【点 击 申 请 此 订 单】")%></A>
                  <% End If %></STRONG></DIV></TD>
                    <TD width=1 bgcolor="#FFDEB5"><IMG height=45 
                  src="images/button_big_r_o.gif" width=2></TD>
                    <TD class=orange width=207><DIV align=center>【已有<%= rs("cishu") %>人申请】</DIV></TD>
                  </TR>
                  <TR><% rs.Close
          set rs=nothing %>
                    <TD colSpan=5 height=20>&nbsp;</TD>
