...
<TABLE cellSpacing=0 cellPadding=0 width=680 align=center bgColor=#ffffff 
  ...
  <TBODY>
    ...
    <TR>
      ...
      <TD height=161 align="center" valign="middle"><span class="STYLE5">教师资格证上传</span>
        <TABLE cellSpacing=1 cellPadding=0 width="100%" bgColor=#cccccc 
        border=0>
          <TBODY>
            <TR>
              <TD height=100 valign="top" background=images/beijin1.gif bgColor=#f3f3f3><DIV class=asho_link_9 align=center>
                  <label></label>
                  <div align="center"> <br>
                      <span class="STYLE4">图片不要超过200k,不然不能传！</span><br>
                     <FORM name=mainForm onSubmit="return mysubmit(this)" enctype="multipart/form-data" action=renzheng03do.asp 
method=post> <input name=mefile type=file class="button" size="50">
                    &nbsp;
