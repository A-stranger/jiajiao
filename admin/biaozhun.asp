...
rs.Open "select zifei from body ",conn,1,3
rs("zifei")=trim(request.form("webimg12"))
rs.update
rs.close
set rs=nothing
...
<table width="519" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr> 
    <td height="26"> <div align="center"><font color="#FFFFFF">收费标准</font></div></td>
  </tr>
  <tr> 
    <td height="107" valign="top" bgcolor="#FFFFFF"> <table width="97%" border="0" align="center" cellpadding="3" cellspacing="0">
        <form name="form1" method="post" action="biaozhun.asp" >
          <%
		  set rs=server.CreateObject("adodb.recordset")
            rs.Open "select zifei from body ",conn,1,1
		%>         
         
          <tr> 
            <td width="172%" COLSPAN="2"> <INPUT type="hidden" name="webimg12" value="<% = Server.HtmlEncode(rs("zifei")) %>">	
