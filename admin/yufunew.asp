...
rs("yufu")=trim(request.form("yufu"))
rs.update
rs.close
set rs=nothing
response.Write "<script language=javascript>alert('     添加成功！');window.location.href='yufu.asp?id="&id&"';</script>"
response.End
end if
 %>
...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  ...
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td width="504" height="66" colspan="-2" align="center" valign="top" bgcolor="#FFFFFF" class="ziti03"><form name="form2" method="post" action="yufunew.asp">
	     <br>
	     <table width="73%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
           ...
           <tr>
             <td height="94" align="center" class="ziti03"><label>
               <input name="yufu" type="text" id="yufu" size="10">
元</label></td>
