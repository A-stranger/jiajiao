...
rs.Open "select * from fuwu",conn,1,3
rs.addnew
...
rs.close
set rs=nothing
response.Write "<script language=javascript>alert('     添加成功！');window.location.href='fuwu.asp';</script>"
response.End
end if
...
<table width="625" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  ...
  <tr> 
    <td height="107" valign="top" bgcolor="#FFFFFF"> <table width="97%" border="0" align="center" cellpadding="3" cellspacing="0">
        <form name="form1" method="post" action="fuwunew.asp" onSubmit="return checkdata()">
             
          <tr> 
            <td width="13%" class="ziti03">学员编号：</td>
            <td width="87%" COLSPAN="2"><input name="title" type="text" class="button" id="title" value="<%= id %>" size="30" maxlength="30" /> 
              <span class="STYLE1">不要加“S”</span></td>
          </tr>
