...
strsql="select * from mingxing where id="&id
  ...
  <tr> 
    ...
    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1">
          ...
          <tr bgcolor="#eeeeee">
            ...
            <td width="73%" bgcolor="#E3E3E3" class="ziti03"><span style="font-size: 10pt">&nbsp;T<%= rs("userid") %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a href="mingxing.asp" class="top">返回</a></span>&nbsp;&nbsp; </td>
          </tr>
          
          <tr bgcolor="#eeeeee">
            <td height="35" class="ziti03"><div align="right">申请内容：</div></td>
            <td bgcolor="#EEEEEE" class="ziti03"><div align="left"><span 
                  class="asho_link_9"><span style="font-size: 10pt"> &nbsp; <%= rs("neirong") %></span></span></div></td>
          </tr>
        </tbody>
    </table>
      <br />
