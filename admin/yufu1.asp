...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26"><div align="center" class="ziti02">教员预付费管理</div></td>
  </tr>
  <tr>
...
strsql="select * from yufu   order by id desc"
...
if rs.eof and rs.bof then 
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="ziti03"><div align="center"><%= rs("yufu") %></div></td>
        <td align="center" bgcolor="#FFFFFF" class="ziti03"><span style="font-size: 10pt"><%= rs("intime") %></span></td>
        <td bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt"><a href="yufudel.asp?id=<%= rs("id") %>&amp;userid=<%= id %>" class="top">删除</a></div></td>
        </tr>
       <%
