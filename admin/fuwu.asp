...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26"><div align="center" class="ziti02">学员服务记录</div></td>
  </tr>
  <tr>
...
注意 ： 
	     ...
	     <a href="fuwunew.asp" class="top">添加新的记录</a></td>
	   </tr>
	 <tr>
	   <td width="109" height="20" align="center" bgcolor="#E8E8E8" class="ziti03">订单(学员编号)</td>
        <td width="255" align="center" bgcolor="#E8E8E8" class="ziti03">记录内容</td>
        <td width="100" bgcolor="#E8E8E8" class="ziti03"><div align="center" >录入时间</div></td>
        <td width="89" bgcolor="#E8E8E8" class="ziti03"><div align="center" >管理员操作</div></td>
      </tr> <% 	 
dim counts
...
if rs.eof and rs.bof then 
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" ><div align="center" class="ffffff"><a href="javascript:if(confirm('确认要删除吗？'))location='fuwudel.asp?id=<%= rs("id") %> '" class="top">删 除</a></div></td>
      </tr>
       <%
