...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26"><div align="center" class="ziti02">明星教员申请</div></td>
  </tr>
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td height="19" colspan="3" bgcolor="#FFFFFF" class="ziti03"><form id="form1" name="form1" method="post" action="mingxing.asp">
	     <label></label>
	     <div align="center">
	       <label>教员编号：
          ...
          <input type="submit" name="Submit" value="查询" />
           ...
           注意 ： 
	     请不要加上 “T” </div>
	   </form>	     <a href="mingxingnew.asp" class="top"></a></td>
	   </tr>
	 <tr>
	   <td width="212" height="20" bgcolor="#E8E8E8" class="ziti03"><div align="center" class="ziti03" >教员编号 </div></td>
        <td width="190" bgcolor="#E8E8E8" class="ziti03"><div align="center" >录入时间</div></td>
        <td width="173" bgcolor="#E8E8E8" class="ziti03"><div align="center" >管理员操作</div></td>
      </tr> <% 	 
dim counts
set rs=server.CreateObject("adodb.recordset")
if id<>"" then
 strsql="select * from mingxing where userid="&id
 else
strsql="select * from mingxing order by id desc"
end if
...
if rs.eof and rs.bof then 
      ...
      <tr>
        <td height="27" bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt"><a href="jiaoyuanshow.asp?id=<%= rs("userid") %>" class="top">T<%= rs("userid") %></a></div></td>
        <td bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt"><%= rs("intime") %></div></td>
        <td bgcolor="#FFFFFF" ><div align="center" class="ffffff"><a href='mingxingshow.asp?id=<%= rs("id") %>' class="top">查看申请资料 </a>/<a href="javascript:if(confirm('确认要删除吗？'))location='mingxingdel.asp?id=<%= rs("id") %> '" class="top">删 除</a></div></td>
      </tr>
       <%
...
response.write "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前共有"&RS.RecordCount&"个申请 "  
