...
<TR>
	<TD>编辑内容：</TD>
	<TD>
		<INPUT type="hidden" name="content1" value="<p>&nbsp;</p><p><font color=#ff0000>本样式为自带默认样式，最佳调用宽度500px，高度350px！</font></p><p>下面为一些高级调用功能的例子，你可以用脚本方便的编辑进行一些操作。</p><p>看到这些内容，且没有错误提示，说明安装已经正确完成！</p><p>你可以先到后台管理中，进行必要的设置，然后再调用！</p><p><b><font color=#0000ff>提示：</font>别忘了改用户和密码、数据库文件名。</b></p>">
		<IFRAME ID="eWebEditor1" src="../ewebeditor.asp?id=content1" frameborder="0" scrolling="no" width="500" height="350"></IFRAME>
	</TD>
</TR>
<TR>
...
<TR>
	<TD>取到内容：</TD>
	<TD><TEXTAREA cols=50 rows=5 id=myTextArea style="width:500px">点击“取值”按钮，看一下效果！</TEXTAREA></TD>
</TR>
<TR>
	<TD colspan=2 align=right>
