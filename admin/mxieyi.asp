...
rs.Open "select mxieyi from body ",conn,1,3
rs("mxieyi")=trim(request.form("webimg12"))
rs.update
rs.close
set rs=nothing
  ...
  <tr> 
    <td height="107" valign="top" bgcolor="#FFFFFF"> <table width="97%" border="0" align="center" cellpadding="3" cellspacing="0">
		...
		%>         
          ...
          <tr> 
            <td width="172%" COLSPAN="2"> <INPUT type="hidden" name="webimg12" value="<% = Server.HtmlEncode(rs("mxieyi")) %>">	
