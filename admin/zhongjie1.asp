...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26"><div align="center" class="ziti02">教员中介费管理</div></td>
  </tr>
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td width="97" height="20" bgcolor="#E8E8E8" class="ziti03"><div align="center" class="ziti03" >教员编号 </div></td>
        <td width="162" bgcolor="#E8E8E8" class="ziti03"><div align="center">所交费用</div></td>
        <td width="183" align="center" bgcolor="#E8E8E8" class="ziti03">缴费日期</td>
        <td width="91" bgcolor="#E8E8E8" class="ziti03"><div align="center" >删除</div></td>
        </tr> <% 	 
dim counts
set rs=server.CreateObject("adodb.recordset")
strsql="select * from zhongjie   order by id desc"
...
if rs.eof and rs.bof then 
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="ziti03"><div align="center"><%= rs("zhongjie") %></div></td>
        <td align="center" bgcolor="#FFFFFF" class="ziti03"><span style="font-size: 10pt"><%= rs("intime") %></span></td>
        <td bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt"><a href="zhongjiedel.asp?id=<%= rs("id") %>&amp;userid=<%= id %>" class="top">删除</a></div></td>
        </tr>
       <%
