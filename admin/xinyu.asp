...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26"><div align="center" class="ziti02">教员资金记录</div></td>
  </tr>
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td height="19" colspan="3" bgcolor="#FFFFFF" class="ziti03"><form id="form1" name="form1" method="post" action="xinyu.asp">
	     <label></label>
	     <div align="center">
	       <label>教员编号：
	     ...
	     <a href="xinyunew.asp" class="top">添加新的记录</a></td>
	   </tr>
	 <tr>
...
if id<>"" then
 strsql="select * from xinyu where userid='"&id&"'"
 else
strsql="select * from xinyu order by id desc"
end if
...
if rs.eof and rs.bof then 
      ...
      <tr>
        <td height="27" bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt">T<%= rs("userid") %></div></td>
        <td bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt"><%= rs("intime") %></div></td>
        <td bgcolor="#FFFFFF" ><div align="center" class="ffffff"><a href='xinyushow.asp?id=<%= rs("id") %>' class="top">查看记录 </a>/<a href="javascript:if(confirm('确认要删除吗？'))location='xinyudel.asp?id=<%= rs("id") %> '" class="top">删 除</a></div></td>
      </tr>
       <%
