...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26"><div align="center" class="ziti02">明星教员管理</div></td>
  </tr>
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td height="19" colspan="5" bgcolor="#FFFFFF" class="ziti03"><form id="form1" name="form1" method="post" action="mingxin.asp">
	     <label></label>
	     <div align="center">
	       <label>教员编号：
...
if id<>"" then
 strsql="select * from jiaoyuan where mingxing='"&dw&"' and id="&id
 else
strsql="select * from jiaoyuan where mingxing='"&dw&"' order by id desc"
end if
