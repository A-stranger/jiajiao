...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26"><div align="center" class="ziti02">教员家教记录</div></td>
  </tr>
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td height="19" colspan="5" bgcolor="#FFFFFF" class="ziti03"><form id="form2" name="form2" method="post" action="xjilu.asp">
	     <label></label>
	     <div align="center">
	       <label>教员编号：
          ...
          <input name="Submit" type="submit" class="button" value="查询" />
           ...
           注意 ： 
	     请不要加上 “T” </div>
	   </form>	 <form id="form1" name="form1" method="post" action="xjilu.asp">
	     <label></label>
	     <div align="center">
	       <label>按教员姓名查询：
...
注意 ： 
	   ...
	   </form>    <form id="form2" name="form2" method="post" action="xjilu.asp">
	     <label></label>
	     <div align="center">
	       <label>学员编号：
          ...
          <input name="Submit" type="submit" class="button" value="查询" />
           ...
           注意 ： 
	     请不要加上 “S” </div>
	   </form>	   <a href="xjilunew.asp" class="top">添加新的记录</a></td>
	 </tr>
	 <tr>
	   <td width="224" height="20" bgcolor="#E8E8E8" class="ziti03"><div align="center" class="ziti03" >教员编号 </div></td>
        <td width="149" align="center" bgcolor="#E8E8E8" class="ziti03">订单(学员编号)</td>
        <td width="149" align="center" bgcolor="#E8E8E8" class="ziti03">性别</td>
        <td width="149" bgcolor="#E8E8E8" class="ziti03"><div align="center" >录入时间</div></td>
        <td width="202" bgcolor="#E8E8E8" class="ziti03"><div align="center" >管理员操作</div></td>
      </tr> <% 	 
dim counts
if xingming<>"" then
...
set rs=server.CreateObject("adodb.recordset")
if id<>"" then
 strsql="select * from xjilu where userid='"&id&"'"
end if
if username<>"" then
...
if idd<>"" then
strsql="select * from xjilu where dingdan="&idd
end if
if idd="" and id=""  and username=""  then
strsql="select * from xjilu order by id desc"
end if
...
if rs.eof and rs.bof then 
      ...
      <tr>
        ...
        <td align="center" bgcolor="#FFFFFF" class="ziti03"><a href="dingdanshow.asp?id=<%= rs("dingdan") %>" class="top">S<%= rs("dingdan") %></a></td>
        <td align="center" bgcolor="#FFFFFF" class="ziti03"><span style="font-size: 10pt"><%= rs("sex") %></span></td>
        <td bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt"><%= rs("intime") %></div></td>
        <td bgcolor="#FFFFFF" ><div align="center" class="ffffff"><a href='xjilushow.asp?id=<%= rs("id") %>' class="top">查看记录 </a>/<a href="javascript:if(confirm('确认要删除吗？'))location='xjiludel.asp?id=<%= rs("id") %> '" class="top">删 除</a></div></td>
      </tr>
       <%
