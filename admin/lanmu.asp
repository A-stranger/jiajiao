...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  <tr>
    <td width="681" height="26" background="images/admin_bg_1.gif"><div align="center" class="ziti04"><%= dw %>管理</div></td>
  </tr>
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td height="20" colspan="3" bgcolor="#FFFFFF" class="ziti03"><a href="lanmu_new.asp?type=<%= dw %>" class="top">添加新的<%= dw %></a>&nbsp;&nbsp;&nbsp;</td>
	   </tr>
	 <tr>
	   <td width="121" bgcolor="#E8E8E8" class="ziti03"><div align="center">
	     <div align="center">所属项目</div>
	   </div></td>
	   <td width="299" height="20" bgcolor="#E8E8E8" class="ziti03"><div align="center" class="ziti03" ><%= dw %>名称</div></td>
        <td width="148" bgcolor="#E8E8E8" class="ziti03"><div align="center" >选 择</div></td>
      </tr> <% 	 

set rs=server.CreateObject("adodb.recordset")
strsql="select * from lanmu where type='"&dw&"' "
...
if rs.eof and rs.bof then 
      ...
      <tr>
        ...
        <td height="27" bgcolor="#FFFFFF" class="ziti03"><div align="center" style="font-size: 10pt"><a href="lanmu_edit.asp?id=<%= rs("id") %>" title="点击修改" class="top"><%= rs("title") %></a></div></td>
      ...
      <table width="430" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="600" align="right"><br />
            <input name="Submit2" type="button" class="button" onclick="this.form.action='lanmu_del.asp';this.form.submit()" value="删 除 选 中" />
&nbsp;
