...
rs("zhongjie")=trim(request.form("zhongjie"))
rs.update
rs.close
set rs=nothing
response.Write "<script language=javascript>alert('     添加成功！');window.location.href='zhongjie.asp?id="&id&"';</script>"
response.End
end if
 %>
...
<table width="683" height="108" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6699cc">
  ...
  <tr>
    <td height="79" valign="top" bgcolor="#FFFFFF"><br>
	 ...
	 <tr>
	   <td width="504" height="66" colspan="-2" align="center" valign="top" bgcolor="#FFFFFF" class="ziti03"><form name="form2" method="post" action="zhongjienew.asp">
	     <br>
	     <table width="73%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
           <tr>
             <td height="47" colspan="2" align="center" class="ziti03"><span class="STYLE1">T<%= id %></span>添加中介费</td>
           </tr>
           <tr>
           ...
           <tr>
             <td height="94" align="center" class="ziti03"><label>
               <input name="zhongjie" type="text" id="zhongjie" size="10">
元</label></td>
