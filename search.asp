        ...
        <TR>
          <TD width=712 align="left">
            ...
            cellSpacing=0 cellPadding=0 width=712>
              <TBODY>
              <TR>
                <TD height="87" align="center" class="px24">以下是您文章检索结果</TD>
              </TR></TBODY></TABLE></TD>
          <TD width=12></TD>
...
if dw<>"" then
strsql="select * from news where type='"&dw&"' and title like '%" & title & "%'  order by id desc"
else
strsql="select * from news where title like '%" & title & "%'  order by id desc"
end if
