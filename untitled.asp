                          ...
                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1">
                            <tbody>
                              <tr bgcolor="#eeeeee">
                                ...
                                <td width="80%" bgcolor="#E3E3E3" class="black9"><span style="font-size: 10pt">&nbsp;<%= rs("dingdan") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">性别：</td>
                                <td bgcolor="#EEEEEE" class="black9"><span 
                  class="asho_link_9"><span style="font-size: 10pt"> &nbsp; <%= rs("sex") %></span></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#E3E3E3" class="black9">学校年级：</td>
                                <td bgcolor="#E3E3E3" class="black9"><span style="font-size: 10pt"> &nbsp; <%= rs("nianji") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">所教科目：</td>
                                <td bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt"> &nbsp; <%= rs("kemu") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#E3E3E3" class="black9">家教时间：</td>
                                <td bgcolor="#E3E3E3" class="black9"><span style="font-size: 10pt">&nbsp; <%= rs("shijian") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">辅导前成绩：</td>
                                <td bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt">&nbsp; <%= rs("chengji1") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#E3E3E3" class="black9">辅导后成绩：</td>
                                <td bgcolor="#E3E3E3" class="black9"><span style="font-size: 10pt">&nbsp; <%= rs("chengji2") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">使用教学方法：</td>
                                <td bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt">&nbsp; <%= rs("fangfa") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#E3E3E3" class="black9">家长评价：</td>
                                <td bgcolor="#E3E3E3" class="black9"><span style="font-size: 10pt">&nbsp; <%= rs("pingjia") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">教学总结：</td>
                                <td bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt">&nbsp; <%= rs("zongjie") %></span></td>
                              </tr>
                              <tr bgcolor="#eeeeee">
                                <td height="35" align="right" bgcolor="#EEEEEE" class="black9">备注：</td>
                                <td bgcolor="#EEEEEE" class="black9"><span style="font-size: 10pt">&nbsp; <%= rs("beizhu") %></span></td>
                              </tr>
                            </tbody>
                          </table>
                          <p>
