...
<TABLE cellSpacing=0 cellPadding=0 width=680 align=center bgColor=#ffffff 
  ...
  <TBODY>
    ...
    <TR>
      ...
      <TD height=161 align="center"><span class="STYLE5">身份证或护照上传</span>
        ...
        <TBODY>
          <TR>
            <TD height=100 valign="top" background=images/beijin1.gif bgColor=#f3f3f3><DIV class=asho_link_9 align=center>
                <label></label>
                <div align="center"> <br>
                    <FORM name=mainForm enctype="multipart/form-data" onSubmit="return mysubmit(this)" action=renzheng01do.asp  method=post>
        ...
        <TABLE cellSpacing=0 cellPadding=0 width=600 border=0>
          <TBODY>
            ...
            <TR>
              <TD height=30><DIV 
            align=center>版权所有：山东家教网</DIV></TD>
            </TR>
          </TBODY>
        </TABLE></TD>
