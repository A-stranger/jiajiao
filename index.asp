...
<META content="www.shandongjijiao.com" name=copyright>
...
<DIV id=c_1_1></DIV>
<DIV id=c_1_2>
  <DIV id=c_1_2_1><STRONG><A class="orange px13" 
href="teacher.asp?d=renzheng" 
target=_blank>·认证教员</A></STRONG>　<A class="blue px13" 
href="waijiao.asp" 
target=_blank>·各类外籍老师</A> </DIV>
  <DIV id=c_1_2_2><STRONG><A class="orange px13" 
href="teacher.asp?d=mingxing" 
target=_blank>·明星教员</A></STRONG>　<A class="blue px13" 
href="tese.asp" 
target=_blank>·名师特色小班</A> </DIV>
  <DIV id=c_1_2_3><STRONG><A class="orange px13" 
href="yingyu.asp" 
target=_blank>·特色英语</A></STRONG>　<A class="blue px13" 
href="yuwen.asp" 
target=_blank>·特色语文小班</A> </DIV>
</DIV>
...
src="images/qinjiajiao.gif" alt="丹江家教网-请家教" width=153 height=94 border="0"></A></DIV>
<DIV id=c_2_2_2>
<DIV id=c_2_2_2_1>+ <A 
href="liucheng.asp">请家教流程</A><BR>
  + 
<A 
...
<DIV id=c_2_2_3><A 
href="zhuce.asp"><IMG 
src="images/zuojiaoyuan_1.gif" alt="丹江家教网-教员注册" border="0"></A></DIV>
<DIV id=c_2_2_4>
<DIV id=c_2_2_4_1>+ <A 
...
<H3 class=normal 
onmousemove="secBoard('hotinfo_caption','infolist',5);">外籍教师</H3>
<H3 class=normal 
onmousemove="secBoard('hotinfo_caption','infolist',6);">学员检索</H3>
<DIV class=search_2><A class=orange 
href="teacher_serch.asp">高级搜索</A></DIV>
...
<P class=p_2>
  <%	
					  dw1="院校"				
set rs=server.CreateObject("adodb.recordset")
rs.Open "select top 10 * from lanmu where type='"&dw1&"'  ",conn,1,3
%>
  <% if rs.eof and rs.bof then %>
&nbsp;&nbsp;&nbsp;&nbsp;
                        暂无记录
...
<P class=p_2>
<A 
href="teacher.asp?kemu=小学语文">小学语文</A> 
<A 
href="teacher.asp?kemu=小学数学">小学数学</A> 
<A 
href="teacher.asp?kemu=小学英语">小学英语</A></P> 
 <P class=p_2>
<A 
href="teacher.asp?kemu=初三语文">初三语文</A> 
<A 
href="teacher.asp?kemu=初三数学">初三数学</A> 
<A 
href="teacher.asp?kemu=初三英语">初三英语</A></P> 
 <P class=p_2>
<A 
href="teacher.asp?kemu=初中物理">初中物理</A> 
<A 
href="teacher.asp?kemu=初中化学">初中化学</A> 
<A 
href="teacher.asp?kemu=初中奥数">初中奥数</A></P> 
 <P class=p_2>
<A 
href="teacher.asp?kemu=高三语文">高三语文</A> 
<A 
href="teacher.asp?kemu=高三数学">高三数学</A> 
<A 
href="teacher.asp?kemu=高三英语">高三英语</A></P> 
<A 
href="teacher.asp?kemu=高中物理">高中物理</A> 
<A 
href="teacher.asp?kemu=高中化学">高中化学</A> 
<A 
href="teacher.asp?kemu=高中地理">高中地理</A></P>  
</DIV>
<DIV id=sort_3>
<P class=p_1>--- 才艺分类 ---</P>
<P class=p_2><A 
...
<DIV id=c_2_3>
<DIV class=c_2_3_1><a href="logoin.asp"><img src="images/login.gif" alt="丹江家教网-会员登录" width=225 
...
欢迎您回来！ <A class=asho_link_9 
                  href="logout.asp">退出</A><br>
<br>
进入：<a href="guanli.asp" style=" color:#0000FF">会员中心</a><br>
<br>
<A class=asho_link_9 href="guanli_jianli.asp">修改简历</A> 
<A class=asho_link_9 href="guanli_jianli.asp" >修改简历</A> <br>
<br>

<A class=asho_link_9 href="guanli_dingdan.asp" >最新订单</A> 
<A class=asho_link_9 
                  href="guanli_xjilu.asp" 
                  target=_self>家教记录</A>
...
<DIV class=c_2_3_1><IMG 
src="images/notice.gif" alt="山东家教网-最新公告" width=225 height=37></DIV>
<DIV id=c_2_3_3>
<% 	 
dw2="最新公告"
set rs=server.CreateObject("adodb.recordset")
...
href="teacher.asp">● 最新有效教员,每日持续增长中...</A></DIV>
<DIV class=c_3_2_3><A 
href="teacher.asp"><IMG 
src="images/teacher_3.gif" alt="山东家教网-专业教师" width=213 height=45 border="0"></A></DIV>
<DIV class=c_3_2_4>
<% 
			  d="是"
			  set rs=server.CreateObject("adodb.recordset")

strsql="select top 5 * from jiaoyuan where kongkai='"&d&"' order by logotime desc,intime desc"
rs.open strsql,conn,1,1
i=0
do while not rs.eof
i=i+1
...
<DIV class=c_3_2_4_1>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="16%" height="22"><a title=点击查看简历 
href="teacher_show.asp?id=<%= rs("id") %>" 
target=_blank><%= left(rs("xingming"),1) %>教员</a></td>
      <td width="22%" height="22"><%= left(rs("zhuanye"),6) %>
			　</td>
      <td width="22%" height="22"><%= left(rs("daxue"),7) %></td>
      <td width="20%" height="22"><%= rs("xueli") %></td>
      <td width="13%" height="22"><%= month(rs("logotime")) %>-<%= day(rs("logotime")) %></td>
      <td width="7%" height="22"><a title=点击查看简历 
href="teacher_show.asp?id=<%= rs("id") %>" 
...
src="images/teacher_star.gif" alt="山东家教网-明星教员" border="0"></A></DIV>
<% 
			  d="是"
			  set rs=server.CreateObject("adodb.recordset")
...
<DIV class=c_3_2_1></DIV>
<DIV class=c_3_2_2><A class=white16 
href="teacher.asp?d=zhuanye">● 专业教师信息库,十分钟前更新...</A></DIV>
<DIV class=c_3_2_3><A 
href="teacher.asp?d=mingxing"><a 
href="teacher.asp?d=zhuanye"><img 
src="images/teacher_4.gif" alt="山东家教网-专业教师" width=213 height=45 border="0"></a></A></DIV>
<DIV class=c_3_2_4>
<% 
			  d="是"
			  set rs=server.CreateObject("adodb.recordset")

strsql="select top 5 * from jiaoyuan where zhunaye='"&d&"' and kongkai='"&d&"' order by logotime desc,intime desc"
rs.open strsql,conn,1,1
i=0
do while not rs.eof
i=i+1
...
<DIV class=c_3_2_4_1>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="16%" height="22"><a title=点击查看简历 
href="teacher_show.asp?id=<%= rs("id") %>" 
target=_blank><%= left(rs("xingming"),1) %>老师</a></td>
      <td width="22%" height="22"><% If rs("xueke")<>"" Then %>
					  <%= left(rs("xueke"),4) %>
					  <% Else %>
					  <%= left(rs("kemu"),4) %>
              <% End If %> 　</td>
      <td width="22%" height="22"><%= rs("daxue") %></td>
      <td width="20%" height="22"><% If rs("dengji")<>"" Then %>
       <%= left(rs("dengji"),8) %>
	  <% Else %>
	 <%response.write("尚无职称等级")%>
       <% End If %> </td>
      <td width="13%" height="22"><%= month(rs("logotime")) %>-<%= day(rs("logotime")) %></td>
      <td width="7%" height="22"><a title=点击查看简历 
href="teacher_show.asp?id=<%= rs("id") %>" 
...
src="images/teacher_music.gif" alt="山东家教网-音乐专才" border="0"></A></DIV> 
<% 
			  d="是"
			  set rs=server.CreateObject("adodb.recordset")
...
href="xueyuan.asp">● 最新家教信息，请尽快申请...</A></DIV>
<DIV class=c_3_2_3><A 
href="xueyuan.asp"><IMG 
src="images/student_3.gif" alt="山东家教网-学员库" width=213 height=45 border="0"></A></DIV>
 <DIV class=c_3_2_4><%
					d="是"
					set rs=server.CreateObject("adodb.recordset")
...
<DIV class=c_3_2_4_1>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="15%" height="22"><%= rs("nianji") %></td>
<td width="20%" height="22"><%= left(rs("xueke"),6) %></td>
<td width="20%" height="22"><%= left(rs("dizhi"),4) %></td>
<td width="25%" height="22"><%= left(rs("anpai"),10) %></td>
<td width="12%" height="22"><%= month(rs("intime")) %>-<%= day(rs("intime")) %></td>
<td width="8%" height="22"><A title=点击查看详情 
href="xueyuan_show.asp?id=<%= rs("id") %>" 
target=_blank>详细</A></td></tr></table></DIV>
<% rs.movenext  									'指向下一条记录
			if rs.eof  then exit do  						'已经到底最后一条记录则跳出
	  	loop 
		rs.close 	
...
src="images/service.gif" alt="" border="0"></A></DIV>
<% 	 
dw2="特色服务"
set rs=server.CreateObject("adodb.recordset")
strsql="select top 5 * from news where type='"&dw2&"' order by id desc"
...
<DIV id=c_4_2_1><IMG 
src="images/zxz_logo.gif" alt="山东家教网资讯站" width=259 height=68></DIV>
<DIV id=c_4_2_2><SELECT name=dw size=1 id="dw"> 
  <OPTION value="" 
  selected>所有文章</OPTION><OPTION value=寻找合适的教员>如何请家教</OPTION>
   <OPTION value=家教直通车>家教直通车</OPTION> <OPTION 
  ...
  value=外语学习>外语学习</OPTION> <OPTION value=教学资源>教学资源</OPTION></SELECT><INPUT id=title 
name=title> 
</DIV>
