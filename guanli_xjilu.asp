...
background=images/top_2_1.gif></TD>
    <TD vAlign=top bgColor=#ffffff><TABLE width="948" border=0 align=center cellPadding=0 cellSpacing=0 bgColor=#ffffff>
      ...
      border=0 align="center" cellPadding=0 cellSpacing=1 bgColor=#cccccc>
          ...
          background=images/my_1_2.gif class=white_link_9><strong><strong><img src="images/my_1_4.gif" width="142" height="58" align="middle"><strong><span class="t">&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;家 教 记 录</span></strong></strong></strong></TD>
                            <TD width="4%" 
...
strsql="select * from xjilu where userid='"&id&"' order by id desc"
      ...
      %>
	   ...
	   %>
                    ...
                    onmouseout="this.style.background='#99CCCC'">
                                        <TD height="23" align=center bgcolor="#6699FF"><div align="center"><span class="STYLE12">订单(编号)</span></div></TD>
                                        <TD align=center bgcolor="#6699FF"><span class="STYLE12">性别 </span></TD>
                                        <TD align=middle bgcolor="#6699FF"><div align="center" class="STYLE12">所授科目</div></TD>
                                        <TD align=center bgcolor="#6699FF"><span class="STYLE12">记录时间</span></TD>
                                        <TD align=middle bgcolor="#6699FF"><div align="center" class="STYLE12">查看</div></TD>
                                      </TR>
                                      <%   do while not rs.eof	and counts>0   %>
                                      <TR onMouseOver="this.style.background='#C4F1FF'" 
                    onmouseout="this.style.background='#C4F1FF'">
                                        <TD width="26%" height="23" align=center bgcolor="#FFFFFF">&nbsp;<a href="xueyuan_show.asp?id=<%= rs("dingdan") %>" class="rose_link_9">S<%= rs("dingdan") %></a></TD>
                                        <TD width="11%" align=center bgcolor="#FFFFFF"><%= rs("sex") %></TD>
                                        <TD width="25%" align=center bgcolor="#FFFFFF"><%= rs("kemu") %></TD>
                                        <TD width="21%" align=center bgcolor="#FFFFFF"><%= rs("intime") %></TD>
                                        <TD width="17%" align=middle bgcolor="#FFFFFF"><div align="center"><a href="guanli_xjilushow.asp?id=<%= rs("id") %>">查看具体</a></div></TD>
                                      </TR>
                                      <%
